...
<body>
    ...
    <form method="POST" action="perfil_cliente.php?formulario=vai" onsubmit="return desativa_btn();">
        <div class="container-cadastrar">
            ...
            <div style='max-height: 100px; overflow:scroll' class='col-4'>
                <span class="label_cadastro">Adversos:</span>
                <table style='border:1px black'>
                    ...
                    $query = "SELECT a.nome as 'adverso',r.nome as 'ramo' FROM ((ramo r INNER JOIN adverso a ON a.id_Ramo = r.id) INNER JOIN processo p ON
                        p.idAdverso = a.id )
            ...
            <div class="col-4">
                <span class="label_cadastro">Novo Adverso:</span>
                <?php 
                echo '<input type="text" name="novoadverso" value="" class="cadastro_input" >';
                ?>
            </div>

            <div class="col-4">
                <span class="label_cadastro">Categoria do Novo Adverso:</span>
                <select class="cadastro_input" name="novoramo">
                    <option value="">Selecione a categoria do novo adverso</option>
                    <?php 
